...
\begin{proc}{recorridoNoCubierto}{\In v: Viaje, \In r: Recorrido,\In u: Dist,\Out res: \TLista{GPS}}{}
	...
	\pred {cubierto} {e: GPS,v: Viaje,u: \ent}{
		(\exists i: \ent)(0 \leq i < \longitud v \yLuego dist(Gps(v[i]),e) \leq 1000 \times u)
		}
...
\begin{proc}{construirGrilla}{\In esq1: GPS, \In esq2: GPS, \In n:\ent, \In m:\ent, \Out g: Grilla}{}
    ...
    \pred {todasLasFilas} {g:Grilla, n: \ent} {
		((\forall i:\ent)(\exists j:\ent)(0 \leq j < \longitud g) (0 < i \leq n \implicaLuego nombre(g[j])_0 = i))
    }
    
    \pred {todasLasColumnas} {g:Grilla, m: \ent} {
		((\forall i:\ent)(\exists j:\ent)(0 \leq j < \longitud g)(0 < i \leq m \implicaLuego nombre(g[j])_1 = i))
    }
...
\begin{proc}{regiones}{\In r: Recorrido,\In g: Grilla,\Out res: \TLista{Nombre}}{}
    ...
    \pred {estaEnGrillaRecorrido}{g: Grilla, r : Recorrido}{
		(\forall j:\ent)(\exists k:\ent)(0 \leq j < \longitud{r} \wedge 0 \leq k < \longitud{q}  \implicaLuego \\ estanEnGrillaGps(g, r[j]))
    }
...
\begin{proc}{cantidadDeSaltos}{\In g: Grilla,\In v: Viaje \Out res: \ent}{}
	\pre{esUnViajeValido(v) \y estanEnGrillaViaje}
	...
	\aux{numeroDeFila}{elem: (Tiempo \times GPS),g: Grilla}{\ent \\}
	{\sum_{i=0}^{\longitud g - 1}\IfThenElse {g[i]_0_0 <= elem_0_0<=g[i]_1_0 }{i}{0}}	

	\aux{numeroDeColumna}{elem: (Tiempo \times GPS),g: Grilla}{\ent \\}
	{\sum_{i=0}^{\longitud g - 1}\IfThenElse {g[i]_0_1 <= elem_0_1<=g[i]_1_1 }{i}{0}}
	
    \pred {estaEnGrillaViaje}{g: Grilla, v : Viaje}{
		(\forall j:\ent)(\exists k:\ent)(0 \leq j < \longitud{v} \wedge 0 \leq k < \longitud{q}  \implicaLuego \\ estanEnGrillaGps(g, Gps(v[j]))
    }
	\end{proc}	
...
\begin{proc}{corregirViaje}{\Inout v:Viaje,\In errores: \TLista{Tiempo}}{}
	...
	estaEnRectayPunto([v[i]_0, puntoCorregido(v[k],v[j])],v[k],v[j]) \implicaLuego Gps(v[i]) = puntoCorregido(v[k],v[j])
	}
...
\begin{proc}{histograma}{\In xs: \TLista{Viaje},\In bins: \ent,out cuentas: \TLista{\ent},out limites: \TLista{\float}}{}
	...
	\pred{esVelocidadMaxima}{i: \ent, v: Viaje}{
		(\forall j: \ent)(0 \leq j < \longitud v \implicaLuego i \geq \frac{dist(Gps(v[j]),distanciaSiguiente(Gps(v[j]),v))}{20})
		}
