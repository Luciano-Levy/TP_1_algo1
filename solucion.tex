...
\begin{proc}{regiones}{\In r: Recorrido,\In g: Grilla,\Out res: \TLista{Nombre}}{}
	\pre{esUnRecorridoValido(r) \y enGrilla(g,r)} % si el recorrido no es valido se puede llegar a indefinir
	\post{(\forall i : \ent)( 0 $\leq$ i $<$ \longitud {res} \implicaLuego res[i]= (numeroFila(r[i],g),numeroColumna(r[i],g)}
	
	\aux{numeroFila}{r: Recorrido ,g: Grilla}{\ent \\}
	{\sum_{i=0}^{\longitud g - 1}\IfThenElse {g[i]_0_0 <= elem_0_0<=g[i]_1_0 }{i}{0}}	

	\aux{numeroColumna}{r: Recorrido, g: Grilla}{\ent \\}
	{\sum_{i=0}^{\longitud g - 1}\IfThenElse {g[i]_0_1 <= elem_0_1<=g[i]_1_1 }{i}{0}}
	
	 \pred {enGrilla} {g: Grilla, r: Recorrido } {
	(\forall i : \ent)(0 \leq i < |r|) ((numeroFila(r[i],g) \neq 0 \y  (numeroColumna(r[i],g) \neq 0)
	}
