...
\item \pred{tiempoEnRango}{ t: Viaje} {
    t_{0} > 0
    }

\item \pred{esUnRecorridoValido}{ r: Recorrido}{
...
\begin{proc}{regiones}{\In r: Recorrido,\In g: Grilla,\Out res: \TLista{Nombre}}{}
	...
	\aux{numeroFila}{elem: (Tiempo \times GPS),g: Grilla}{\ent \\}
	{\sum_{i=0}^{\longitud g - 1}\IfThenElse {g[i]_0_0 <= elem_0_0<=g[i]_1_0 }{i}{0}}	

	\aux{numeroColumna}{elem: (Tiempo \times GPS),g: Grilla}{\ent \\}
...
\begin{proc}{cantidadDeSaltos}{\In g: Grilla,\In v: Viaje \Out res: \ent}{}
	...
	\post{res = sumSaltos(g,v)}
	 ...
	 \pred {enGrilla} {g: Grilla, v: Viaje} {
...
<<<<<<< HEAD
	aux sumSaltos ( g: Grilla, v: Viaje) {
...
>>>>>>> 2ca3e31cfc4083b8f51298a6d27fd43e0bb38252
...
\begin{proc}{corregirViaje}{\Inout v:Viaje,\In errores: \TLista{Tiempo}}{}
	...
	\post{\longitud{v} = \longitud{v_0} \y
	errorPrincipio(v_0[0]_0) \y 
	errorFinal(v_0[\longitud{v_0}-1]_0) \y 
	(\forall i:\ent)(0 < i < \longitud{v}-1 \implicaLuego )}

	\pred{enRecta}{g,p1,p2: GPS}{
		(\exists r: \float)(r \times (p2_0 - p1_0) + p1_0 = g_0) \y \\
		(r \times (p2_1 - p1_1) + p1_1 = g_1) \y \\
		(p1_0 \leq g_0 \leq p2_0 \y p1_1 \leq g_1 \leq p2_1)
		}
	\aux{validoCercanoAtras}{v:Viaje,errores: \TLista{Tiempo},i: \ent}{(Tiempo \times GPS) \\}
	{\IfThenElse{\neq(v[i-1]_0 \in errores)}{v[i-1]}{validoCercanoAtras(v,errores,i-1)}}

	\aux{validoCercanoAdelante}{v:Viaje,errores: \TLista{Tiempo},i: \ent}{(Tiempo \times GPS)\\}
	{\IfThenElse{\neq(v[i+1]_0 \in errores)}{v[i+1]}{validoCercanoAtras(v,errores,i+1)}}
\end{proc}
...
<<<<<<< HEAD
	\post{limitesValidos(limites,bins,xs) \y cuentasValidas()}
...
>>>>>>> 2ca3e31cfc4083b8f51298a6d27fd43e0bb38252
	...
	\pred{velMayoryMenordeMaximas}{velMayorMaxima,velMenorMaxima,limites: \TLista{\float}, bins: \ent}{
