...
\begin{proc}{cantidadDeSaltos}{\In g: Grilla,\In v: Viaje \Out res: \ent}{}
	...
	\pred {esUnSalto} {\In g: Grilla, \In v: Viaje,\In i: \ent}{ 
		(\exists j : \ent)(0 \leq j < |v| \wedge  v[j]_{0} -  v[i]_{0} = 20) \yLuego (|(numeroFila(v[j]_{1}, g) - numeroFila(v[i]_{1}, g)| \geq 3) \vee (|numeroColumna(v[j]_{1}, g) - numeroColumna(v[i]_{1}, g)| \geq 3)) }	
