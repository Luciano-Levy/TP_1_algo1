...
\begin{proc}{regiones}{\In r: Recorrido,\In g: Grilla,\Out res: \TLista{Nombre}}{}
	\pre{esUnRecorridoValido(r), enGrilla(g,r)} % si el recorrido no es valido se puede llegar a indefinir
	\post{(\forall i : \ent)( 0 $\leq$ i $<$ \longitud r \implicaLuego res[i]= (numeroFila(r[i],g),numeroColumna(r[i],g)}
	
	\aux{numeroFila}{in r: Recorrido ,g: Grilla}{\ent \\}
	{\sum_{i=0}^{\longitud g - 1}\IfThenElse {g[i]_0_0 <= elem_0_0<=g[i]_1_0 }{i}{0}}	

	\aux{numeroColumna}{in r: Recorrido, g: Grilla}{\ent \\}
	{\sum_{i=0}^{\longitud g - 1}\IfThenElse {g[i]_0_1 <= elem_0_1<=g[i]_1_1 }{i}{0}}
	
	 \pred {enGrilla} {\In g: Grilla, \In r: Recorrido } {
...
\begin{proc}{cantidadDeSaltos}{\In g: Grilla,\In v: Viaje \Out res: \ent}{}
	...
	\pred {esUnSalto} {\In g: Grilla, \In v: Viaje,\In i: \ent}{ 
		(\exists j : \ent)(0 \leq j < |v|)  v[j]_{0} -  v[i]_{0} = 20 \yLuego (|(numeroFila(v[j]_{1}, g) - numeroFila(v[i]_{1}, g)| \geq 3) \vee (|numeroColumna(v[j]_{1}, g) - numeroColumna(v[i]_{1}, g)| \geq 3)) }	
