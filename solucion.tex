...
\begin{proc}{excesoDeVelocidad}{\In v: Viaje, \In r: Recorrido,\In u: Dist,\Out res: \TLista{GPS}}{}
	\pre{esUnViajeValido() \wedge esUnRecorridoValido \wedge u \geq 0} % HACER EL PREDICADO DE esUnRecorridoValido
...
\begin{proc}{regiones}{\In r: Recorrido,\In g: Grilla,\Out res: \TLista{NOMBRE}}{}
	\pre{}
	\post{(\forall i : \ent)( 0 $\leq$ i $<$ \longitud v \implicaLuego res _i= (numeroDeFila(r_i,g),numeroDeColumna(r_i,g)}
	
	\aux{numeroDeFila}{in elem: (Tiempo \times GPS),g: Grilla}{\ent \\}
	{\sum_{i=0}^{\longitud g - 1}\IfThenElse {g[i]_0_0 <= elem_0_0<=g[i]_1_0 }{i}{0}}	

	\aux{numeroDeColumna}{in elem: (Tiempo \times GPS),g: Grilla}{\ent \\}
