...
\item \pred{esUnViajeValido}{\In v: Viaje}{
	...
	% Esta mal porque falta chequear el ultimo elemento de viaje esta en rango
	% Se me ocurre hacer un pred que cheque rango y otro que estan cada 20m

    \pred{gpsEnRango}{\In g1: GPS, \In g2: GPS}{
		( (-90.0 \leq g1_{0} \leq 90.0) \y (-180.0 \leq g1_{1} \leq 180.0) ) \y (  dist(g1,g2) \approx 20 )
    }
...
\begin{proc}{flota}{\In v: \TLista{Viaje},\In t_{0}: Tiempo, \In t_{f}: Tiempo,  \Out res: \ent}{}
	\pre{(\forall i : \ent)(0 \leq i < \longitud v \implicaLuego esUnViajeValido)}
