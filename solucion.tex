...
\begin{proc}{regiones}{\In r: Recorrido,\In g: Grilla,\Out res: \TLista{Nombre}}{}
	\pre{esUnrecorridoValido(r)} % si el recorrido no es valido se puede llegar a indefinir
...
\begin{proc}{corregirViaje}{\Inout v:Viaje,\In errores: \TLista{Tiempo}}{}
	\pre{\longitud{v} > 5 \y esUnViajeValido(v) \y \longitud{errores} \leq 0.1 \times \longitud{v} \y v = v_0 }
